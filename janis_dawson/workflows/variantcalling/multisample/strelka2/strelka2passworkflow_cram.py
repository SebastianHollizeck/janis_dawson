...
from .steps.strelka2passanalysisstep1_cram import Strelka2PassWorkflowStep1
from .steps.strelka2passanalysisstep2_cram import Strelka2PassWorkflowStep2
...
class Strelka2PassWorkflowCram(BioinformaticsWorkflow):
    def id(self):
